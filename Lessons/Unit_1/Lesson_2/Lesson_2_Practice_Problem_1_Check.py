...
def check_answer():
  ...
  if "problem_1_solution_value" not in globals():

    print("You must generate the problem before checking the answer.")

    return
  
  solution_value = problem_1_solution_value
  solution_units = problem_1_solution_units

  ##==============================================================================================##
  ## Set the Student's Answer:                                                                    ##
  ##==============================================================================================##

  if ("answer_1_value" not in globals()) or ("answer_1_units" not in globals()):

    print("You must fully answer the problem before checking the answer.")

    return

  given_value = answer_1_value 
  given_units = answer_1_units
