...
def check_answer():
  ...
  if "problem_3_solution_value" not in globals():

    print("You must generate the problem before checking the answer.")

    return
  
  solution_value = problem_3_solution_value
  solution_units = problem_3_solution_units

  ##==============================================================================================##
  ## Set the Student's Answer:                                                                    ##
  ##==============================================================================================##

  if ("answer_3_value" not in globals()) or ("answer_3_units" not in globals()):

    print("You must fully answer the problem before checking the answer.")

    return

  given_value = answer_3_value 
  given_units = answer_3_units
