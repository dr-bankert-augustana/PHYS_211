...
velocity = np.array([rd.uniform(v_min, v_max), 0])
...
velocity_history.append([velocity[0], velocity[1]])
...
history_df = pd.DataFrame(
    {
        "Time (s)": time_history,
        "Velocity X (m/s)": [v[0] for v in velocity_history],
        "Velocity Y (m/s)": [v[1] for v in velocity_history],
    }
)
